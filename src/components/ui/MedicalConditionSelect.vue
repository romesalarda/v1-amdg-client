<!-- Replace MedicalConditionSelect.vue with this file (adds multiple prop + clear) -->
<template>
  <div ref="containerRef" class="w-full min-w-0">
    <div
      ...
      @click="openDropdown"
    >
      <span class="material-symbols-outlined text-primary text-base shrink-0">medication</span>
      <input
        ref="inputRef"
        v-model="searchQuery"
        type="text"
...
import { useMedicalConditionSearch } from '~/composables/resources/attendee/useMedicalConditionSearch'
...
const { options, isLoading } = useMedicalConditionSearch(searchQuery)
