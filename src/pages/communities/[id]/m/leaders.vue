        ...
        <div class="space-y-8">
            <div class="bg-white border-2 border-deep-navy rounded-xl shadow-drawn">
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div v-else-if="candidateUsers.length > 0" class="space-y-3">
                        <div
            ...
            <div class="bg-white border-2 border-deep-navy rounded-xl shadow-drawn">
                ...
                <div v-else-if="filteredLeaders.length > 0" class="divide-y-2 divide-deep-navy/5">
                    <div v-for="leader in filteredLeaders" :key="leader.id" class="px-8 py-6 flex items-center justify-between gap-6">
                        <div>
...
const filteredLeaders = computed(() => {
    ...
    return leaders.value.filter((leader: any) => {
        return leader.location_type === selectedLocationType.value && leader.location_id === selectedLocationId.value
    })
})
