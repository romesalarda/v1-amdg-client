            ...
            <div class="flex items-center gap-4">
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center gap-2 mt-2">
                  ...
                  <UBadge v-if="(attendee.data.value?.data as any)?.is_checked_in" color="green" variant="soft" size="xs">G�� Checked In</UBadge>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4 text-center">
              ...
              <div class="flex items-center justify-center gap-2 mb-3">
                <UBadge v-if="attendee.data.value?.data?.is_minor" color="amber" variant="soft" size="xs">
                  {{ attendee.data.value?.data?.age }} years G�� Minor
                </UBadge>
