...
/**
 * Get Current User Booking For Event
 *
 * Retrieve the current authenticated user's booking for this event, including attendees, tickets, and payments in a single payload. Selection precedence is: booking created by current user, otherwise latest booking where user is linked as an attendee.
 */
