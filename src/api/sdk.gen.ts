 ...
 */
export const eventStaffInvitesList2 = <ThrowOnError extends boolean = false>(options?: Options<EventStaffInvitesList2Data, ThrowOnError>) => (options?.client ?? client).get<EventStaffInvitesList2Responses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
